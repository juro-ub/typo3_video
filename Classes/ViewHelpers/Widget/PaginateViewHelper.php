...
namespace Jro\Videoportal\ViewHelpers\Widget;
/*                                                                        *
...
{
    /**
     * @var \Jro\Videoportal\ViewHelpers\Widget\Controller\PaginateController
     */
    protected $controller;

    /**
     * @param \Jro\Videoportal\ViewHelpers\Widget\Controller\PaginateController $controller
     * @return void
     */
    public function injectController(\Jro\Videoportal\ViewHelpers\Widget\Controller\PaginateController $controller)
    {
    ...
    {
        $this->registerArgument('configuration', 'array', 'Config', TRUE);
        $this->registerArgument('as', 'string', 'search string', TRUE);
        $this->registerArgument('objects', 'object', 'Items', TRUE);
    }
